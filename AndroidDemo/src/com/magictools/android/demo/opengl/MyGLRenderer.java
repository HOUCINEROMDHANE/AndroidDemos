...
//	    public Runnable logicLoop = new Runnable() {
//	        public void run() {
//	            while(gameRunning) {
//	                loops = 0;
//	                while (... your timing checks here...) {
//	                    updateLogic();
//	                    loops++;
//	                }
//	                //.. if manually triggering rendering
...
//	    new Thread(logicLoop).start();
	    ...
	    updateThread = new Thread(new Runnable() {
	        @Override public void run()
	        {
	            ...
	            while (!mExit)
	            {
	            	MyGLActivity.mGLView.requestRender();
	                //mAngle++;
	...
	//---------------
	{
		...
		//System.out.println("--- rtri: " + rtri + ", rquad: " + rquad + " ---");
	}
